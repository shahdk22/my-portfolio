...
function App() {
  ...
  return (
    <div className="bg-white text-gray-900 min-h-screen">
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {[
                ...
                <button
                  key={item}
                  onClick={() => scrollToSection(item)}
                  className="block px-3 py-2 text-base font-medium text-gray-600 hover:text-emerald-600 hover:bg-gray-50 rounded-md w-full text-left"
                >
                  {item.charAt(0).toUpperCase() + item.slice(1)}
                </button>
              ))}
      ...
      <section
        id="home"
        className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-emerald-50 via-cyan-50 to-blue-50"
      >
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-emerald-300 to-cyan-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
          <div className="absolute top-40 right-20 w-72 h-72 bg-gradient-to-r from-pink-300 to-rose-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse animation-delay-2000"></div>
          <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-gradient-to-r from-violet-300 to-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse animation-delay-4000"></div>
        </div>

        <div className="text-center z-10 px-4 max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="inline-flex items-center px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full text-sm font-medium text-emerald-600 mb-6 border border-emerald-200">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              I build modern, responsive websites that provide seamless user
              experiences using the latest web
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button
              ...
              className="group px-8 py-4 bg-gradient-to-r from-emerald-600 to-cyan-600 text-white rounded-full font-semibold hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 transform hover:scale-105 flex items-center"
            >
              View My Work
            ...
            <button
              ...
              className="px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-full font-semibold hover:border-emerald-500 hover:text-emerald-600 transition-all duration-300 flex items-center"
            >
          ...
          <div className="flex justify-center space-x-6">
            <a
              href="#"
              className="w-12 h-12 bg-white/60 backdrop-blur-sm rounded-full flex items-center justify-center text-gray-600 hover:text-emerald-600 hover:bg-white transition-all duration-300 transform hover:scale-110 border border-gray-200"
            >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-3xl transform rotate-3"></div>
              <img
                src={photo}
                alt="Profile"
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={tech}
                    className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-medium hover:bg-emerald-100 hover:text-emerald-700 transition-colors duration-200"
                  >
                    {tech}
                  </span>
                ))}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="group bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100"
              >
                <div
                ...
                <div className="mt-6 flex items-center text-emerald-600 font-medium group-hover:text-cyan-600 transition-colors duration-300">
                  Learn More
                  <i className="fas fa-arrow-right ml-2 group-hover:translate-x-1 transition-transform duration-300"></i>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="group relative bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100"
              >
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <i className="fas fa-play text-gray-400 group-hover:text-emerald-600 transition-colors duration-300"></i>
                  </div>

                  <h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-emerald-600 transition-colors duration-300">
                    {project.title}
                  </h3>
      ...
      <section
        id="testimonials"
        className="py-24 px-4 bg-gradient-to-br from-emerald-50 via-cyan-50 to-blue-50"
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:bg-white/80 transition-all duration-300 transform hover:-translate-y-2"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center p-4 bg-gray-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">shahdddd@email.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gray-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">+20 1031225353</div>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-gray-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Mansoura</div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex space-x-4 pt-4">
                <a
                  href="#"
                  className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-600 hover:bg-emerald-100 hover:text-emerald-600 transition-all duration-300 transform hover:scale-110"
                >
                  <i className="fab fa-github text-xl"></i>
                </a>
                <a
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-200"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <div>
                ...
                <textarea
                  rows={6}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:border-emerald-500 focus:bg-white focus:outline-none transition-all duration-200 resize-none"
                ></textarea>
              </div>
